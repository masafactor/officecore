    ...
    public function index(Request $request)
{
    ...
    $wageTableId = $request->input('wage_table_id');

    [$rows, $summary, $wageTables] = $this->buildPayrollRows($month, $wageTableId);
    ...
    return Inertia::render('Admin/Payrolls/PartTime/Index', [
        ...
        'filters' => [
            'wage_table_id' => $wageTableId ? (string) $wageTableId : '',
        ],
    ]);
}
    public function csv(Request $request): StreamedResponse
    {
        ...
        [$rows] = $this->buildPayrollRows($month, $wageTableId);
    ...
    private function buildPayrollRows(string $month, $wageTableId = null): array
    {
        ...
        $users = User::query()
            ->whereHas('userEmployments', function ($query) use ($end, $wageTableId) {
                ...
                if (!empty($wageTableId)) {
                    $query->where('wage_table_id', $wageTableId);
                }
            })
            ->with([
        ...
        return [$rows, $summary, $wageTables];
    }
